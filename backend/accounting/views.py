...
class ComputeGain(APIView):
    ...
    def get(self, request, slug):
        ...
        total_c = orders_item.aggregate(Sum("total_product_company_price"))["total_product_company_price__sum"] # total company price per product in orders item
        try:
...
class ComputeGainWithTime(APIView):
    ...
    def post(self, request):
        ...
        total_c = orders_item.aggregate(Sum("total_product_company_price"))["total_product_company_price__sum"]
        try:
            result = total_f - total_c
        except:
            result = 0
